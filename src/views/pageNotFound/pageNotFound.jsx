...
export default function PageNotFound() {
    return (
        <div className="min-h-screen flex flex-col items-center text-center px-4 ">
            ...
            <Link className="inline-block border-2 border-blue-500 text-blue-500 px-6 py-3 rounded-full hover:bg-blue-500 hover:text-white hover:shadow-lg hover:shadow-blue-400 transition-all duration-200"
